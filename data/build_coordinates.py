...
def main(argv):
  ...
  coord_3d_array = np.array(coord_3d)
  num_elements = coord_3d_array.size
  num_columns = 3
  num_rows = num_elements // num_columns 
  logging.info('unravel success')  
  reshaped_coord_3d = coord_3d_array.reshape(num_rows, num_columns)
  print('the number of coordinates: ', reshaped_coord_3d.shape[0])

  
  np.save(FLAGS.coordinate_output, reshaped_coord_3d)
